...
# Currently they are debugged
{
  ...
  # Antigua, en formato para 2 variables
  ...
  {
    # No la voy a utilizar, es únicamente para comprobaciones
    ...
    # Ha quedado subsumida en la que sirve para más de 2 niveles (shiftesAOVMM)
    #  pero la conservo por si acaso y después la quitaré
...
# For function adjustment (come from LibrFunc.R)
{
  ...
  # I will test the old code and add improvements to it
 {
  ...
  # I'll leave them for illustrative purposes, but I've grouped them all together in --> AdjParms.G
   ...
   # Drv --> Ya está arriba como DrvAsymReg
   # addTrans --> Previous section
   
   # Estos dos creo que los voy a quitar
